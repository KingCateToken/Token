...
contract KingCate is Context, IBEP20, Ownable {
    ...
    string private _name = "KingCate";
    string private _symbol = "KingCate";
    ...
    address payable public buybackAddress = payable(0xccaB0f63EC8265d72b813B2673Fe881F6fB95106);
    address payable public marketingAddress = payable(0x40060A8B01BcF929b337dD00e63a04D83F54CeDC);
    address payable public lpAddress = payable(0x36B9B8d65e261f83aF4F0008d7365CcD1Ea23AB0);
    address payable public stakingAddress = payable(0x3f87A1FEc1dad272010268b46e498C03cF9ee732);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 buybackBalance = transferredBalance.sub(marketingBalance);
